...
- **Source connection string.** This field is labeled optional — left blank, it defaults to the connection you launched the wizard from — but **set it explicitly**: `mongodb://bookadmin:bookpass123@10.0.0.5:27017/?replicaSet=rs0&authSource=admin` (substitute your VM private IP).
